...
swiftc "${COMMON[@]}" Sources/ProjectSweepApp/PreviewSafety.swift Sources/ProjectSweepApp/FolderGrants.swift Sources/ProjectSweepApp/ProjectLibraryStore.swift Sources/ProjectSweepApp/BrowserState.swift Sources/ProjectSweepApp/ProjectTree.swift Sources/ProjectSweepApp/ToolInspection.swift Sources/ProjectSweepApp/SkillManagementState.swift Sources/ProjectSweepApp/SweepState.swift Tests/Acceptance/MultipleLibraryChecks.swift "${CORE_OBJECTS[@]}" -o "$CHECK_DIR/multiple-library-checks"
"$CHECK_DIR/multiple-library-checks"

swiftc "${COMMON[@]}" Sources/ProjectSweepApp/PreviewSafety.swift Sources/ProjectSweepApp/FolderGrants.swift Sources/ProjectSweepApp/ProjectLibraryStore.swift Sources/ProjectSweepApp/BrowserState.swift Sources/ProjectSweepApp/ProjectTree.swift Sources/ProjectSweepApp/ToolInspection.swift Sources/ProjectSweepApp/SkillManagementState.swift Sources/ProjectSweepApp/SweepState.swift Tests/Acceptance/BatchRestoreChecks.swift "${CORE_OBJECTS[@]}" -o "$CHECK_DIR/batch-restore-checks"
"$CHECK_DIR/batch-restore-checks"
